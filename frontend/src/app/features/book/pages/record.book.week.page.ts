...
import {BookWeekEditComponent} from '@features/book/components/week/book.week.edit.component';
    ...
    <layout-component>
      <box-component>
        ...
        @if (this.week().isEmpty()) {
          ...
          <book-week-edit-component [bookWeek]="this.week().get()"></book-week-edit-component>
        }
